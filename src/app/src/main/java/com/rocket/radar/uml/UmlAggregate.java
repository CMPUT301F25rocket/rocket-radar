...
/**
 * Annotation to mark fields that represent an aggregation relationship in UML diagrams.
 * This is used for documentation purposes to indicate that one class contains references
 * to instances of another class, where the contained objects can exist independently.
 */
